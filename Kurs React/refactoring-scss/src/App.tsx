...
import BlogCard from "./components/Section/BlogCard/BlogCard";
import ContactForm from "./components/Section/ContactForm/ContactForm"
import TeamCard from "./components/Section/TeamCard/TeamCard";
  ...
  return (
    <div className={`portfolio ${darkMode ? "dark-theme" : "light-theme"}`}>
      ...
      <div className="content-card">
        ...
        <BlogCard blogdata={companyData.blogPosts}/>
        <ContactForm />
      </div>
