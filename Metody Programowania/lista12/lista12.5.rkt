...
(module+ test
  ...
  (test (parse `{rec fact {n} {if {= n 0} 1 {* n {fact {- n 1}}}}})
        (recE
         'fact
         'n
 (ifE
  (appE (appE (varE '=) (varE 'n)) (numE 0))
  (numE 1)
  (appE (appE (varE '*) (varE 'n)) (appE (varE 'fact) (appE (appE (varE '-) (varE 'n)) (numE 1))))))))
